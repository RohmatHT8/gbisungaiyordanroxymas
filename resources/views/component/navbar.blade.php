    ...
    <nav class="flex justify-between items-center w-[92%]  mx-auto">
        ...
        <div
            ...
            <ul class="flex md:flex-row flex-col md:items-center md:gap-[4vw] gap-8 text-xl">
                <li>
                    <a class="text-white hover:text-yellow-200" href="#">Beranda</a>
                </li>
                <li>
                    <a class="text-white hover:text-yellow-200" href="#">Tentang Kami</a>
                </li>
                <li>
                    <a class="text-white hover:text-yellow-200" href="#">Layanan</a>
                </li>
                <li>
                    <a class="text-white hover:text-yellow-200" href="#">Komunitas</a>
                </li>
                <li>
                    <a class="text-white hover:text-yellow-200" href="#">Hubungi Kami</a>
                </li>
            </ul>
        </div>
